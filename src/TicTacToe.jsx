...
const TicTacToe = () => {
  ...
  return (
    <div className=" flex flex-col justify-center items-center p-5 bg-white bg-opacity-20 w-fit rounded shadow-lg shadow-slate-600">
      <h2 className=" mb-4 text-2xl font-bold font-serif text-gray-200">
        Tic Tac Toe Game
      </h2>
      {!gameStarted ? (
        <button
        ...
        <div className="w-64">
          ...
          {winner && (
            <div className="mt-4 text-center">
              <p className="font-bold text-xl text-gray-200">{winner} wins!</p>
              <button
